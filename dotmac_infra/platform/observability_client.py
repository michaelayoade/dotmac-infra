...
class ObservabilityClient:
    ...
    def trace(self, operation: str, trace_id: Optional[str] = None):
        ...
        try:
            self.base_logger.info(f"Trace started: {operation}", extra={
                "trace_id": trace_id,
                "tenant_id": self.tenant_id,
                "operation": operation
            })
            ...
            self.base_logger.error(f"Trace failed: {operation}", extra={
                "trace_id": trace_id,
                "tenant_id": self.tenant_id,
                "operation": operation,
            ...
            self.base_logger.info(f"Trace completed: {operation}", extra={
                "trace_id": trace_id,
                "tenant_id": self.tenant_id,
                "operation": operation,
                "duration_ms": duration_ms
...
class ComponentLogger:
    ...
    def __init__(self, base_logger, tenant_id: str, component: str):
        self.base_logger = base_logger
        self.tenant_id = tenant_id
